...
function Financial() {
  const slides = [
    {
      url: "http://advisor.brighthemes.biz/demo/wp-content/uploads/2016/08/services-img1-1.jpg",
    },
    {
      url: "http://advisor.brighthemes.biz/demo/wp-content/uploads/2016/08/about-img1.jpg",
    },
  ];
            ...
            <div className="col-span-3 ">
              ...
              <div className="mt-8">
                <p className="text-lg">
                  ...
                  all this mistaken idea of denouncing. expound the actual
                  teachings. of the great explorer of the truth, the
                  master-builder of No one rejects, dislikes, or human
                  happiness.
                </p>
                ...
                <div className="flex max-md:flex-col">
                  <p className="text-xl">
                    ...
                    eiusmod tempor xercitationemut labore. Lorem ipsum dolor sit
                    amet, consectetur adipiscing elit. Aenean bibendum nec risus
                    et suscipit Curabitur metus ipsum.
                  </p>
